...
public class MessageTest {
    ...
    public void testMessageLengthSuccess() {
        ...
        // The system should return "Message ready to send." when the message is within 250 characters
        message msg = new message(0, "+27718693002", "Hi Mike, can you join us for dinner tonight?");
    ...
    public void testMessageLengthFailure() {
        ...
        // The system should return the exact failure message with how many characters over the limit it is
    ...
    public void testMessageHashCorrect() {
        // Test 7: Verifying the hash is built correctly
        // Expected hash format: 00:0:HITONIGHT (first two digits of ID : message number : first word + last word in caps)
